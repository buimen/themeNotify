		...
		<div class="content">
			...
			<div class="content-main">
				<div class="main-top">
					...
					<div class="col-sm-6">
						<iframe width="560" height="315" src="https://www.youtube.com/embed/AQm9GDjVdgs" frameborder="0" allowfullscreen></iframe>
					</div>
				</div>
			</div>
				...
				<div class="slide">
					<!-- <marquee> -->
						<?php
							for ($i = 1; $i <=21; $i++) {
						?>
							<a href="#"><img src="images/slide-<?php echo $i; ?>.png" title="Ghi chú cho ảnh"/> </a>
						<?php
							}
						?>
					<!-- </marquee> -->
